...
public class Comment {
    ...
    @Field(name = "spid") @Indexed(unique = true) private int spid;
    @Field(name = "users_nickname") private String users_nickname;
    @Field(name = "report_bad") private int report_bad;
    @Field(name = "like") private int like;
